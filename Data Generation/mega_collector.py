...
data = os.path.join(rootdir, "es") # Rename the conllu file name to en "Shining-Through\Data Generation\Datasets\europarl\data\DE_en_conllu" here "DE_en_conllu" -> "en"
