...
data = os.path.join(rootdir, "es") # Rename dethe conllu file name to en "Shining-Through\Data Generation\Datasets\europarl\data\DE_en_conllu" here "DE_en_conllu" -> "en"
outname = data + 'es.csv' # Write language name for which you are extracting feature here
...
basic_stats = {}
#languages = ['en', 'de', 'ru']
languages = ['es'] #since all data is in german
adv_support = {}
mpred_support = {}
pseudo_deverbs = {}
vconverts = {}
